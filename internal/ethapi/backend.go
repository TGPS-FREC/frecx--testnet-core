...
type Backend interface {
	...
	FRExService() *FREx.FREX
	LendingService() *FRExlending.Lending
	...
	GetEVM(ctx context.Context, msg core.Message, state *state.StateDB, FRExState *tradingstate.TradingStateDB, header *types.Header, vmCfg vm.Config) (*vm.EVM, func() error, error)
	...
	return []rpc.API{
		{
			...
			Namespace: "FREx",
			Version:   "1.0",
			Service:   NewPublicFREXTransactionPoolAPI(apiBackend, nonceLock),
			Public:    true,
		}, {
			Namespace: "txpool",
			Version:   "1.0",
