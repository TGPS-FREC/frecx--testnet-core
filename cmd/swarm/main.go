...
import (
	...
	"github.com/FRECNET/swarm"
	bzzapi "github.com/FRECNET/swarm/api"
	swarmmetrics "github.com/FRECNET/swarm/metrics"
...
func bzzd(ctx *cli.Context) error {
	...
	//FRE only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for FRE and swarm
