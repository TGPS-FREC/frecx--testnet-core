...
contract FREValidator {
    ...
    event Staked(address _owner,uint256 _cap);
    ...
    modifier onlyValidCandidateCap {
        // anyone can deposit X FRE to become a candidate
    ...
    function stakeMore() external payable onlyValidCandidateCap onlyKYCWhitelisted onlyValidCandidate(msg.sender) {
        uint256 cap = validatorsState[msg.sender].cap.add(msg.value);
        validatorsState[msg.sender].cap = cap;
