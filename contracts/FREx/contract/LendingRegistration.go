...
// LAbstractFREXListingABI is the input ABI used to generate the binding from.
const LAbstractFREXListingABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"getTokenStatus\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"

// LAbstractFREXListingBin is the compiled bytecode used for deploying new contracts.
const LAbstractFREXListingBin = `0x`

// DeployLAbstractFREXListing deploys a new Ethereum contract, binding an instance of LAbstractFREXListing to it.
func DeployLAbstractFREXListing(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *LAbstractFREXListing, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractFREXListingABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(LAbstractFREXListingBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &LAbstractFREXListing{LAbstractFREXListingCaller: LAbstractFREXListingCaller{contract: contract}, LAbstractFREXListingTransactor: LAbstractFREXListingTransactor{contract: contract}, LAbstractFREXListingFilterer: LAbstractFREXListingFilterer{contract: contract}}, nil
}

// LAbstractFREXListing is an auto generated Go binding around an Ethereum contract.
type LAbstractFREXListing struct {
	LAbstractFREXListingCaller     // Read-only binding to the contract
	LAbstractFREXListingTransactor // Write-only binding to the contract
	LAbstractFREXListingFilterer   // Log filterer for contract events
}

// LAbstractFREXListingCaller is an auto generated read-only Go binding around an Ethereum contract.
type LAbstractFREXListingCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractFREXListingTransactor is an auto generated write-only Go binding around an Ethereum contract.
type LAbstractFREXListingTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractFREXListingFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type LAbstractFREXListingFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractFREXListingSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type LAbstractFREXListingSession struct {
	Contract     *LAbstractFREXListing // Generic contract binding to set the session for
	CallOpts     bind.CallOpts         // Call options to use throughout this session
	TransactOpts bind.TransactOpts     // Transaction auth options to use throughout this session
}

// LAbstractFREXListingCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type LAbstractFREXListingCallerSession struct {
	Contract *LAbstractFREXListingCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts               // Call options to use throughout this session
}

// LAbstractFREXListingTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type LAbstractFREXListingTransactorSession struct {
	Contract     *LAbstractFREXListingTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts               // Transaction auth options to use throughout this session
}

// LAbstractFREXListingRaw is an auto generated low-level Go binding around an Ethereum contract.
type LAbstractFREXListingRaw struct {
	Contract *LAbstractFREXListing // Generic contract binding to access the raw methods on
}

// LAbstractFREXListingCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type LAbstractFREXListingCallerRaw struct {
	Contract *LAbstractFREXListingCaller // Generic read-only contract binding to access the raw methods on
}

// LAbstractFREXListingTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type LAbstractFREXListingTransactorRaw struct {
	Contract *LAbstractFREXListingTransactor // Generic write-only contract binding to access the raw methods on
}

// NewLAbstractFREXListing creates a new instance of LAbstractFREXListing, bound to a specific deployed contract.
func NewLAbstractFREXListing(address common.Address, backend bind.ContractBackend) (*LAbstractFREXListing, error) {
	contract, err := bindLAbstractFREXListing(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &LAbstractFREXListing{LAbstractFREXListingCaller: LAbstractFREXListingCaller{contract: contract}, LAbstractFREXListingTransactor: LAbstractFREXListingTransactor{contract: contract}, LAbstractFREXListingFilterer: LAbstractFREXListingFilterer{contract: contract}}, nil
}

// NewLAbstractFREXListingCaller creates a new read-only instance of LAbstractFREXListing, bound to a specific deployed contract.
func NewLAbstractFREXListingCaller(address common.Address, caller bind.ContractCaller) (*LAbstractFREXListingCaller, error) {
	contract, err := bindLAbstractFREXListing(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractFREXListingCaller{contract: contract}, nil
}

// NewLAbstractFREXListingTransactor creates a new write-only instance of LAbstractFREXListing, bound to a specific deployed contract.
func NewLAbstractFREXListingTransactor(address common.Address, transactor bind.ContractTransactor) (*LAbstractFREXListingTransactor, error) {
	contract, err := bindLAbstractFREXListing(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractFREXListingTransactor{contract: contract}, nil
}

// NewLAbstractFREXListingFilterer creates a new log filterer instance of LAbstractFREXListing, bound to a specific deployed contract.
func NewLAbstractFREXListingFilterer(address common.Address, filterer bind.ContractFilterer) (*LAbstractFREXListingFilterer, error) {
	contract, err := bindLAbstractFREXListing(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &LAbstractFREXListingFilterer{contract: contract}, nil
}

// bindLAbstractFREXListing binds a generic wrapper to an already deployed contract.
func bindLAbstractFREXListing(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractFREXListingABI))
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractFREXListing *LAbstractFREXListingRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractFREXListing.Contract.LAbstractFREXListingCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractFREXListing *LAbstractFREXListingRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractFREXListing.Contract.LAbstractFREXListingTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractFREXListing *LAbstractFREXListingRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractFREXListing.Contract.LAbstractFREXListingTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractFREXListing *LAbstractFREXListingCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractFREXListing.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractFREXListing *LAbstractFREXListingTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractFREXListing.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractFREXListing *LAbstractFREXListingTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractFREXListing.Contract.contract.Transact(opts, method, params...)
}
...
func (_LAbstractFREXListing *LAbstractFREXListingCaller) GetTokenStatus(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _LAbstractFREXListing.contract.Call(opts, out, "getTokenStatus", arg0)
	return *ret0, err
}
...
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractFREXListing *LAbstractFREXListingSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractFREXListing.Contract.GetTokenStatus(&_LAbstractFREXListing.CallOpts, arg0)
}

// GetTokenStatus is a free data retrieval call binding the contract method 0xa3ff31b5.
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractFREXListing *LAbstractFREXListingCallerSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractFREXListing.Contract.GetTokenStatus(&_LAbstractFREXListing.CallOpts, arg0)
}
...
// FREXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function FREXListing() constant returns(address)
func (_Lending *LendingCaller) FREXListing(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Lending.contract.Call(opts, out, "FREXListing")
	return *ret0, err
}
...
//
// Solidity: function FREXListing() constant returns(address)
func (_Lending *LendingSession) FREXListing() (common.Address, error) {
	return _Lending.Contract.FREXListing(&_Lending.CallOpts)
}

// FREXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function FREXListing() constant returns(address)
func (_Lending *LendingCallerSession) FREXListing() (common.Address, error) {
	return _Lending.Contract.FREXListing(&_Lending.CallOpts)
}
