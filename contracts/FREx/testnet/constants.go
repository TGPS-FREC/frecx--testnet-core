...
var (
	BaseFRE     = big.NewInt(0).Mul(big.NewInt(10), big.NewInt(100000000000000000)) // 1 FRE
	...
	// TRC21 Token
	MinTRC21Apply  = big.NewInt(0).Mul(big.NewInt(10), BaseFRE) // 10 FRE
	TRC21TokenCap  = big.NewInt(0).Mul(big.NewInt(1000000000000), BaseFRE)
	TRC21TokenFee  = big.NewInt(0)
	FREXListingFee = big.NewInt(0).Mul(big.NewInt(1000), BaseFRE) // 1000 FRE

	// FREX
	MaxRelayers               = big.NewInt(200)
	MaxTokenList              = big.NewInt(200)
	MinDeposit                = big.NewInt(0).Mul(big.NewInt(25000), BaseFRE) // 25000 FRE
	...
	FRENative = common.HexToAddress("0x0000000000000000000000000000000000000001")
	...
	TeamAddresses = []common.Address{
		...
		common.HexToAddress("0x16a73f3a64eca79e117258e66dfd7071cc8312a9"), // BTCFRE
		common.HexToAddress("0xac177441ac2237b2f79ecff1b8f6bca39e27ef9f"), // ETHFRE
		common.HexToAddress("0x4215250e55984c75bbce8ae639b86a6cad8ec126"), // XRPFRE
		common.HexToAddress("0x6b70ca959814866dd5c426d63d47dde9cc6c32d2"), // LTCFRE
		common.HexToAddress("0x33df079fe9b9cd7fb23a1085e4eaaa8eb6952cb3"), // BNBFRE
		common.HexToAddress("0x3cab8292137804688714670640d19f9d7a60c472"), // ADAFRE
		common.HexToAddress("0x9415d953d47c5f155cac9de7b24a756f352eafbf"), // ETCFRE
		common.HexToAddress("0xe32d2e7c8e8809e45c8e2332830b48d9e231e3f2"), // BCHFRE
		common.HexToAddress("0xf76ddbda664ea47088937e1cf9ff15036714dee3"), // EOSFRE
		...
		common.HexToAddress("0xe36c1842365595D44854eEcd64B11c8115E133EF"), // FREUSDT
