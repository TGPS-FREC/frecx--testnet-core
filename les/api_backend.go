...
func (b *LesApiBackend) GetEVM(ctx context.Context, msg core.Message, state *state.StateDB, FRExState *tradingstate.TradingStateDB, header *types.Header, vmCfg vm.Config) (*vm.EVM, func() error, error) {
	state.SetBalance(msg.From(), math.MaxBig256)
	context := core.NewEVMContext(msg, header, b.eth.blockchain, nil)
	return vm.NewEVM(context, state, FRExState, b.eth.chainConfig, vmCfg), state.Error, nil
}
...
func (b *LesApiBackend) FRExService() *FREx.FREX {
	return nil
}

func (b *LesApiBackend) LendingService() *FRExlending.Lending {
	return nil
}
