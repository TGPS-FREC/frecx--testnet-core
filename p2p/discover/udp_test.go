...
func TestUDP_packetErrors(t *testing.T) {
	...
	test.packetIn(errExpired, pingFRE, &ping{From: testRemote, To: testLocalAnnounced, Version: Version})
...
func TestUDP_successfulPing(t *testing.T) {
	...
	go test.packetIn(nil, pingFRE, &ping{From: testRemote, To: testLocalAnnounced, Version: Version, Expiration: futureExp})
