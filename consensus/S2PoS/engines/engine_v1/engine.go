...
import (
	...
	"github.com/FRECNET/consensus/misc"
...
func New(config *params.S2PoSConfig, db ethdb.Database) *S2PoS_v1 {
...
func (x *S2PoS_v1) Author(header *types.Header) (common.Address, error) {
	return ecrecover(header, x.signatures)
}

// VerifyHeader checks whether a header conforms to the consensus rules.
func (x *S2PoS_v1) VerifyHeader(chain consensus.ChainReader, header *types.Header, fullVerify bool) error {
...
func (x *S2PoS_v1) VerifyHeaders(chain consensus.ChainReader, headers []*types.Header, fullVerifies []bool) (chan<- struct{}, <-chan error) {
...
func (x *S2PoS_v1) verifyHeaderWithCache(chain consensus.ChainReader, header *types.Header, parents []*types.Header, fullVerify bool) error {
...
func (x *S2PoS_v1) verifyHeader(chain consensus.ChainReader, header *types.Header, parents []*types.Header, fullVerify bool) error {
	...
	// Ensure that the block doesn't contain any uncles which are meaningless in S2PoS_v1
...
func (x *S2PoS_v1) verifyCascadingFields(chain consensus.ChainReader, header *types.Header, parents []*types.Header, fullVerify bool) error {
...
func (x *S2PoS_v1) checkSignersOnCheckpoint(chain consensus.ChainReader, header *types.Header, signers []common.Address) error {
	number := header.Number.Uint64()
...
func (x *S2PoS_v1) IsAuthorisedAddress(header *types.Header, chain consensus.ChainReader, address common.Address) bool {
...
func (x *S2PoS_v1) GetSnapshot(chain consensus.ChainReader, header *types.Header) (*SnapshotV1, error) {
	number := header.Number.Uint64()
...
func (x *S2PoS_v1) GetAuthorisedSignersFromSnapshot(chain consensus.ChainReader, header *types.Header) ([]common.Address, error) {
	snap, err := x.GetSnapshot(chain, header)
	if err != nil {
		return nil, err
	}
...
func (x *S2PoS_v1) StoreSnapshot(snap *SnapshotV1) error {
...
func (x *S2PoS_v1) GetMasternodes(chain consensus.ChainReader, header *types.Header) []common.Address {
...
func (x *S2PoS_v1) GetPeriod() uint64 { return x.config.Period }
...
func (x *S2PoS_v1) YourTurn(chain consensus.ChainReader, parent *types.Header, signer common.Address) (int, int, int, bool, error) {
	masternodes := x.GetMasternodes(chain, parent)

	// if common.IsTestnet {
	// 	// Only three mns hard code for FRE testnet.
...
func (x *S2PoS_v1) snapshot(chain consensus.ChainReader, number uint64, hash common.Hash, parents []*types.Header, selfHeader *types.Header) (*SnapshotV1, error) {
...
func (x *S2PoS_v1) VerifyUncles(chain consensus.ChainReader, block *types.Block) error {
...
func (x *S2PoS_v1) VerifySeal(chain consensus.ChainReader, header *types.Header) error {
...
func (x *S2PoS_v1) verifySeal(chain consensus.ChainReader, header *types.Header, parents []*types.Header, fullVerify bool) error {
...
func (x *S2PoS_v1) GetValidator(creator common.Address, chain consensus.ChainReader, header *types.Header) (common.Address, error) {
...
func (x *S2PoS_v1) Prepare(chain consensus.ChainReader, header *types.Header) error {
...
func (x *S2PoS_v1) UpdateMasternodes(chain consensus.ChainReader, header *types.Header, ms []utils.Masternode) error {
	number := header.Number.Uint64()
...
func (x *S2PoS_v1) Finalize(chain consensus.ChainReader, header *types.Header, state *state.StateDB, parentState *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt) (*types.Block, error) {
	// set block reward
	number := header.Number.Uint64()
	rCheckpoint := chain.Config().S2PoS.RewardCheckpoint
...
// with.
func (x *S2PoS_v1) Authorize(signer common.Address, signFn clique.SignerFn) {
	x.lock.Lock()
	defer x.lock.Unlock()
...
func (x *S2PoS_v1) Seal(chain consensus.ChainReader, block *types.Block, stop <-chan struct{}) (*types.Block, error) {
	header := block.Header()
...
// current signer.
func (x *S2PoS_v1) CalcDifficulty(chain consensus.ChainReader, time uint64, parent *types.Header) *big.Int {
	return x.calcDifficulty(chain, parent, x.signer)
}

func (x *S2PoS_v1) calcDifficulty(chain consensus.ChainReader, parent *types.Header, signer common.Address) *big.Int {
...
func (x *S2PoS_v1) RecoverSigner(header *types.Header) (common.Address, error) {
	return ecrecover(header, x.signatures)
}

func (x *S2PoS_v1) RecoverValidator(header *types.Header) (common.Address, error) {
	// If the signature's already cached, return that
	hash := header.Hash()
...
func (x *S2PoS_v1) GetMasternodesFromCheckpointHeader(preCheckpointHeader *types.Header, n, e uint64) []common.Address {
...
func (x *S2PoS_v1) GetDb() ethdb.Database {
	return x.db
}
...
func (x *S2PoS_v1) getSignersFromContract(chain consensus.ChainReader, checkpointHeader *types.Header) ([]common.Address, error) {
	startGapBlockHeader := checkpointHeader
	number := checkpointHeader.Number.Uint64()
	for step := uint64(1); step <= chain.Config().S2PoS.Gap; step++ {
...
func NewFaker(db ethdb.Database, config *params.S2PoSConfig) *S2PoS_v1 {
	var fakeEngine *S2PoS_v1
	// Set any missing consensus parameters to their defaults
	conf := config
