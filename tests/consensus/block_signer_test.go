...
func TestNotUpdateSignerListIfNotOnGapBlock(t *testing.T) {
	blockchain, backend, parentBlock := PrepareFRETestBlockChain(t, 400, params.TestS2PoSMockChainConfig)
...
func TestNotChangeSingerListIfNothingProposedOrVoted(t *testing.T) {
	blockchain, _, parentBlock := PrepareFRETestBlockChain(t, GAP-1, params.TestS2PoSMockChainConfig)
	// Insert block 450
...
func TestUpdateSignerListIfVotedBeforeGap(t *testing.T) {
	...
	blockchain, backend, parentBlock := PrepareFRETestBlockChain(t, GAP-2, params.TestS2PoSMockChainConfig)
...
func TestCallUpdateM1WithSmartContractTranscation(t *testing.T) {
	...
	blockchain, backend, currentBlock := PrepareFRETestBlockChain(t, GAP-1, params.TestS2PoSMockChainConfig)
...
func TestStatesShouldBeUpdatedWhenForkedBlockBecameMainChainAtGapBlock(t *testing.T) {
	...
	blockchain, backend, parentBlock := PrepareFRETestBlockChain(t, GAP-1, params.TestS2PoSMockChainConfig)
