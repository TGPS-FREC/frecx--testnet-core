...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	case ghash == params.MainnetGenesisHash:
		return params.FREMainnetChainConfig
...
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.FREMainnetChainConfig,
		Nonce:      0,
...
func DeveloperGenesisBlock(period uint64, faucet common.Address) *Genesis {
	...
	config := *params.AllS2PoSProtocolChanges
	config.S2PoS.Period = period
...
func DecodeMainnet() GenesisAlloc {
	...
	json.Unmarshal([]byte(FREAllocData), &mainnetAlloc)
	return mainnetAlloc
}
