...
func TestDefaultGenesisBlock(t *testing.T) {
	...
	if block.Hash() != params.FREMainnetGenesisHash {
		t.Errorf("wrong mainnet genesis hash, got %v, want %v", block.Hash().String(), params.FREMainnetGenesisHash.String())
	}
...
func TestSetupGenesis(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantHash:   params.FREMainnetGenesisHash,
			wantConfig: params.FREMainnetChainConfig,
		},
		{
