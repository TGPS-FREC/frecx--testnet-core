...
func makelist(g *core.Genesis) allocList {
	...
	fmt.Println("g.Alloc:::",g.Alloc)
	for addr, account := range g.Alloc {
		fmt.Println("acount.storage::::",account.Storage)
		fmt.Println("acount.Code::::",account.Code)
		fmt.Println("acount.Nonce::::",account.Nonce)
		fmt.Println("acount.addr::::",addr)
