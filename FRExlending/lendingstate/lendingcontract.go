...
//		- isSpecialCollateral			: TRUE if collateral is a token which is NOT available for trading in FREX, otherwise FALSE
...
// @param statedb : current state
// @return: list of terms which FRExlending supports
