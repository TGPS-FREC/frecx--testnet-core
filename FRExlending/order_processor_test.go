...
func Test_getCancelFee(t *testing.T) {
	FREx := FREx.New(&FREx.DefaultConfig)
	...
	FREx.SetTokenDecimal(testTokenB, new(big.Int).Exp(big.NewInt(10), big.NewInt(8), nil))
	...
	tradingStateDb.SetMediumPriceBeforeEpoch(tradingstate.GetTradingOrderBookHash(testTokenB, common.HexToAddress(common.FRENativeAddress)), common.BasePrice)
	...
	tests := []struct {
		...
		// COLLATERAL TOKEN: FRE

		// zero fee test: LEND
		{
			"TokenA/FREzero fee test: LEND",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
					CollateralToken: common.HexToAddress(common.FRENativeAddress),
					Quantity:        new(big.Int).SetUint64(10000),
		...
		// zero fee test: BORROW
		{
			"TokenA/FRE zero fee test: BORROW",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
		...
		// test getCancelFee: LEND
		{
			"TokenA/FRE test getCancelFee:: LEND",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
		...
		// test getCancelFee:: BORROW
		{
			"TokenA/FRE test getCancelFee:: BORROW",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
		...
		// zero fee test: LEND
		{
			"FRE/TokenA zero fee test: LEND",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.FRENativeAddress),
		...
		// zero fee test: BORROW
		{
			"FRE/TokenA zero fee test: BORROW",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.FRENativeAddress),
		...
		// test getCancelFee: LEND
		{
			"FRE/TokenA  test getCancelFee:: LEND",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.FRENativeAddress),
		...
		// test getCancelFee:: BORROW
		{
			"FRE/TokenA  test getCancelFee:: BORROW",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.FRENativeAddress),
