...
import (
	...
	"github.com/FRECNET/internal/jsre"
	"github.com/FRECNET/internal/web3ext"
...
func (c *Console) Welcome() {
	// Print some generic FRE metadata
	fmt.Fprintf(c.printer, "Welcome to the FRE JavaScript console!\n\n")
	c.jsre.Run(`
